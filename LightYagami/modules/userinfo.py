...
from LightYagami import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from LightYagami.__main__ import STATS, TOKEN, USER_INFO
import LightYagami.modules.sql.userinfo_sql as sql
from LightYagami.modules.disable import DisableAbleCommandHandler
from LightYagami.modules.sql.global_bans_sql import is_user_gbanned
from LightYagami.modules.sql.afk_sql import is_afk, check_afk_status
from LightYagami.modules.sql.users_sql import get_user_num_chats
...
from LightYagami import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "Lemme Remember His/Her Info from My IQ", parse_mode=ParseMode.HTML)
